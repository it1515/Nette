<?php
// source: D:\www\kronika\app/config/config.neon 
// source: D:\www\kronika\app/config/config.local.neon 

class Container_16a5d13210 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\KurzyManager' => [1 => ['27_App_Model_KurzyManager']],
		...
		'services' => [
			...
			'27_App_Model_KurzyManager' => 'App\Model\KurzyManager',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'D:\www\kronika\app',
			'wwwDir' => 'D:\www\kronika\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'D:\www\kronika\app/../temp',
		];
	}
	...
	/**
	 * @return App\Model\KurzyManager
	 */
	public function createService__27_App_Model_KurzyManager()
	{
		$service = new App\Model\KurzyManager($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('27_App_Model_KurzyManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\www\kronika\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\www\kronika\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\www\kronika\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=kurzy', 'root',
			NULL, ['lazy' => TRUE]);
	...
	{
		return new Container_16a5d13210_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_16a5d13210_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_16a5d13210 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('D:\www\kronika\app/../temp/cache/latte');
