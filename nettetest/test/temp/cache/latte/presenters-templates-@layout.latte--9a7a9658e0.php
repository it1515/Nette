<?php
// source: C:\xampp\htdocs\trasy-reseni\app\presenters/templates/@layout.latte

use Latte\Runtime as LR;

class Template9a7a9658e0 extends Latte\Runtime\Template
{
	public $blocks = [
		'head' => 'blockHead',
...
?>
    ...
    <footer class="text-center">
        <hr>
        <p>&copy; SŠPU Opava 2017, maturitní práce, autor Jan Novák</p>
    </footer>    
<?php
