<?php
// source: D:\www\kornika-test\app\presenters/templates/@layout.latte

use Latte\Runtime as LR;

class Templatec9f966b4ec extends Latte\Runtime\Template
{
	public $blocks = [
		'head' => 'blockHead',
...
<body
    <header>
        <div class="jumbotron">
            <h1 class="text-center">MARATÓN V4</h1>
            <hr>
            <h3 class="text-center">Střední Evropa v poklusu</h3>
        </div>
