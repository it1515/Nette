<?php
// source: C:\xampp\htdocs\zavody-reseni\app/config/config.neon 
// source: C:\xampp\htdocs\zavody-reseni\app/config/config.local.neon 

class Container_5efa2c0f0f extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\StartlistManager' => [1 => ['27_App_Model_StartlistManager']],
			...
			'App\Presenters\StartlistPresenter' => [1 => ['application.5']],
		...
		'services' => [
			...
			'27_App_Model_StartlistManager' => 'App\Model\StartlistManager',
			...
			'application.5' => 'App\Presenters\StartlistPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\zavody-reseni\app',
			'wwwDir' => 'C:\xampp\htdocs\zavody-reseni\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp\htdocs\zavody-reseni\app/../temp',
		];
	}
	...
	/**
	 * @return App\Model\StartlistManager
	 */
	public function createService__27_App_Model_StartlistManager()
	{
		$service = new App\Model\StartlistManager($this->getService('database.default.context'));
		return $service;
	}
	...
	/**
	 * @return App\Presenters\StartlistPresenter
	 */
	public function createServiceApplication__5()
	{
		$service = new App\Presenters\StartlistPresenter($this->getService('27_App_Model_StartlistManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\zavody-reseni\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\zavody-reseni\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\zavody-reseni\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=zavod', 'root',
			'', ['lazy' => TRUE]);
	...
	{
		return new Container_5efa2c0f0f_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_5efa2c0f0f_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_5efa2c0f0f $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp\htdocs\zavody-reseni\app/../temp/cache/latte');
