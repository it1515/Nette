<?php
// source: D:\www\kronika-test\app/config/config.neon 
// source: D:\www\kronika-test\app/config/config.local.neon 

class Container_54be833f64 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'D:\www\kronika-test\app',
			'wwwDir' => 'D:\www\kronika-test\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'D:\www\kronika-test\app/../temp',
		];
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\www\kronika-test\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\www\kronika-test\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\www\kronika-test\app/../temp/cache',
	...
	{
		return new Container_54be833f64_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_54be833f64_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_54be833f64 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('D:\www\kronika-test\app/../temp/cache/latte');
