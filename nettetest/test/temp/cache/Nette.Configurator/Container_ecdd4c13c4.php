<?php
// source: C:\xampp\htdocs\trasy-reseni\app/config/config.neon 
// source: C:\xampp\htdocs\trasy-reseni\app/config/config.local.neon 

class Container_ecdd4c13c4 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\TrasyManager' => [1 => ['27_App_Model_TrasyManager']],
			...
			'App\Presenters\TrasyPresenter' => [1 => ['application.5']],
		...
		'services' => [
			...
			'27_App_Model_TrasyManager' => 'App\Model\TrasyManager',
			...
			'application.5' => 'App\Presenters\TrasyPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\trasy-reseni\app',
			'wwwDir' => 'C:\xampp\htdocs\trasy-reseni\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp\htdocs\trasy-reseni\app/../temp',
		];
	}
	...
	/**
	 * @return App\Model\TrasyManager
	 */
	public function createService__27_App_Model_TrasyManager()
	{
		$service = new App\Model\TrasyManager($this->getService('database.default.context'));
		return $service;
	}
	...
	/**
	 * @return App\Presenters\TrasyPresenter
	 */
	public function createServiceApplication__5()
	{
		$service = new App\Presenters\TrasyPresenter($this->getService('27_App_Model_TrasyManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\trasy-reseni\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\trasy-reseni\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\trasy-reseni\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=turistika', 'root',
			'', ['lazy' => TRUE]);
	...
	{
		return new Container_ecdd4c13c4_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_ecdd4c13c4_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_ecdd4c13c4 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp\htdocs\trasy-reseni\app/../temp/cache/latte');
