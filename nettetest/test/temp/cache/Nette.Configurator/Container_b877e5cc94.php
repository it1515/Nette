<?php
// source: D:\www\kornika-test\app/config/config.neon 
// source: D:\www\kornika-test\app/config/config.local.neon 

class Container_b877e5cc94 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\ZavodManager' => [1 => ['28_App_Model_ZavodManager']],
		...
		'services' => [
			...
			'28_App_Model_ZavodManager' => 'App\Model\ZavodManager',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'D:\www\kornika-test\app',
			'wwwDir' => 'D:\www\kornika-test\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'D:\www\kornika-test\app/../temp',
		];
	}
	...
	/**
	 * @return App\Model\ZavodManager
	 */
	public function createService__28_App_Model_ZavodManager()
	{
		$service = new App\Model\ZavodManager($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('28_App_Model_ZavodManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\www\kornika-test\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\www\kornika-test\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\www\kornika-test\app/../temp/cache',
	...
	{
		return new Container_b877e5cc94_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_b877e5cc94_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_b877e5cc94 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('D:\www\kornika-test\app/../temp/cache/latte');
